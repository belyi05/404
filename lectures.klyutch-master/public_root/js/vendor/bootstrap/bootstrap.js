    ...
    $.fn.alert =
        function ( option ) {
            return this.each ( function () {
                ...
                if (!data) $this.data ( 'bs.alert', (data =
                    new Alert ( this )) )
        ...
        function () {
            ...
            if ($parent.length) {
                ...
                if ($input.prop ( 'type' ) == 'radio') {
                    if ($input.prop ( 'checked' ) && this.$element.hasClass ( 'active' )) changed =
                        false
    ...
    $.fn.button =
        function ( option ) {
            return this.each ( function () {
                ...
                if (!data) $this.data ( 'bs.button', (data =
...
+function ( $ ) {
    ...
    Carousel.prototype.slide =
        function ( type, next ) {
            ...
            if ($next.hasClass ( 'active' )) return this.sliding =
                false
    ...
    $.fn.carousel =
        function ( option ) {
            return this.each ( function () {
                ...
                if (!data) $this.data ( 'bs.carousel', (data =
    ...
    $ ( document ).on ( 'click.bs.carousel.data-api', '[data-slide], [data-slide-to]', function ( e ) {
        ...
        if (slideIndex) options.interval =
            false
        ...
        function ( option ) {
            return this.each ( function () {
                ...
                if (!data && options.toggle && option == 'show') option =
                    !option
                if (!data) $this.data ( 'bs.collapse', (data =
...
+function ( $ ) {
    ...
    var old = $.fn.modal
    $.fn.modal =
        function ( option, _relatedTarget ) {
            return this.each ( function () {
                var $this = $ ( this )
                var data = $this.data ( 'bs.modal' )
                var options = $.extend ( {}, Modal.DEFAULTS, $this.data (), typeof option == 'object' && option )
                if (!data) $this.data ( 'bs.modal', (data =
...
+function ( $ ) {
    ...
    Tooltip.prototype.getDelegateOptions =
        function () {
            ...
            this._options && $.each ( this._options, function ( key, value ) {
                if (defaults[key] != value) options[key] =
                    value
            } )
            return options
        }
    Tooltip.prototype.enter =
        function ( obj ) {
    ...
    Tooltip.prototype.applyPlacement =
    ...
    Tooltip.prototype.replaceArrow =
        function ( delta, dimension, position ) {
...
+function ( $ ) {
    ...
    function ScrollSpy ( element, options ) {
        ...
        this.$element =
            $ ( element ).is ( 'body' ) ? $ ( window ) : $ ( element )
        this.$body =
            $ ( 'body' )
        this.$scrollElement =
            this.$element.on ( 'scroll.bs.scroll-spy.data-api', process )
        this.options =
            $.extend ( {}, ScrollSpy.DEFAULTS, options )
        this.selector =
            (this.options.target
                || ((href =
        ...
        function () {
            ...
            if (scrollTop >= maxScroll) {
                return activeTarget != (i =
                    targets.last ()[0]) && this.activate ( i )
            }
            if (activeTarget && scrollTop <= offsets[0]) {
                return activeTarget != (i =
                    targets[0]) && this.activate ( i )
            }
            for ( i =
                      offsets.length; i--; ) {
    ...
    $.fn.scrollspy =
        function ( option ) {
            return this.each ( function () {
                ...
                var options = typeof option == 'object' && option
                if (!data) $this.data ( 'bs.scrollspy', (data =
                    new ScrollSpy ( this, options )) )
                if (typeof option == 'string') data[option] ()
            } )
        }
    $.fn.scrollspy.Constructor =
        ScrollSpy
...
+function ( $ ) {
    ...
    Affix.prototype.checkPosition =
        function () {
            ...
            if (this.affixed == 'top') position.top +=
                scrollTop
    ...
    $.fn.affix =
        function ( option ) {
            return this.each ( function () {
                ...
                var options = typeof option == 'object' && option
                if (!data) $this.data ( 'bs.affix', (data =
